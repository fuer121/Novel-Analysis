...
export function BookWorkspacePage() {
  ...
  return <section className="book-workspace">
    ...
    <nav className="workspace-tabs" aria-label="书籍工作区">
      <NavLink to="overview">概览</NavLink><NavLink to="import">导入</NavLink><NavLink to="l1">L1 索引</NavLink><NavLink to="l2">L2 索引与事实</NavLink><NavLink to="query">连续提问</NavLink><NavLink to="analysis">高级分析</NavLink>
    </nav>
