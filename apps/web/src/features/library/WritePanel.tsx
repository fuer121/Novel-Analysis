...
export function WritePanel(props: { title: string; description: string; previewPath: string; submitPath: string; previewBody: object; submitBody?: object; previewKind?: "index" | "import"; children?: React.ReactNode }) {
  ...
  const previewMutation = useMutation({ mutationFn: () => apiWrite<ActionPreview>(props.previewPath, { method: "POST", body: JSON.stringify(props.previewBody) }), onSuccess: (value) => { setPreview(value); setScopeChanged(false); } });
