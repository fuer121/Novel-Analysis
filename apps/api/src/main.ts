...
const analysisModel = process.env.ADVANCED_ANALYSIS_MODEL;
const analysisReasoningEffort = process.env.ADVANCED_ANALYSIS_REASONING_EFFORT;
const analysisExecutorVersion = process.env.ADVANCED_ANALYSIS_EXECUTOR_VERSION;
...
if (!analysisModel || !analysisReasoningEffort || !analysisExecutorVersion) throw new Error("Advanced analysis execution configuration is required");
