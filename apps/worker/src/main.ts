...
const libraryExecutor = libraryConfig
  ? new LibraryImportExecutor({
      database,
      adapter: new HttpDifyAdapter({ fetch: globalThis.fetch, baseUrl: libraryConfig.baseUrl, credentials: { "chapter-import": libraryConfig.chapterImportKey, "l1-index": "unused", "l2-index": "unused" }, timeoutMs: 60_000 }),
