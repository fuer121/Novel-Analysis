...
interface AnalysisRunsTable { id: Generated<string>; book_id: string; created_by: string; template_version_id: string; job_id: string; mode: AnalysisMode; start_chapter: number; end_chapter: number; status: AnalysisRunStatus; execution_signature: string; execution_snapshot_ciphertext: Buffer | null; execution_snapshot_nonce: Buffer | null; execution_snapshot_auth_tag: Buffer | null; execution_snapshot_key_version: string | null; completed_parts: Generated<number>; total_parts: number; result_ciphertext: Buffer | null; result_nonce: Buffer | null; result_tag: Buffer | null; result_key_version: string | null; diagnostics: Json; error_code: string | null; created_at: GeneratedTimestamp; updated_at: GeneratedTimestamp }
