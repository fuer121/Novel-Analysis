...
| Phase 5 | Controller protocol correction V6 BLOCKED，deadline custody scheduled | V6 failed双审与raw custody已durable登记，heartbeat保持V2首次schedule并顺序接力至V6；任何真实config、snapshot、diagnostic、UAT、部署或retry保持locked |
